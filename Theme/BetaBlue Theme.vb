...
Class BetaBlueTheme
    ...
    Public Overrides Sub PaintHook()
        ...
        DrawGradient(Color.FromArgb(0, 95, 218), Color.FromArgb(0, 55, 202), 0, 0, Width, 25, 90S)   ' Form Top Bar

        DrawCorners(Color.Fuchsia, ClientRectangle)   ' Then draw some clean corners
        DrawBorders(Pens.DarkBlue, Pens.DodgerBlue, ClientRectangle)   ' Then we draw our form borders

        G.DrawLine(Pens.Black, 0, 25, Width, 25)   ' Top Line
        'G.DrawLine(Pens.Black, 0, Height - 25, Width, Height - 25)   ' Bottom Line

        DrawText(HorizontalAlignment.Left, Color.White, 8, 2)   ' Finally, we draw our text
    End Sub
End Class ' BetaBlue Theme
Class BetaBlueButton
    ...
    Overrides Sub PaintHook()
        Dim GradA, GradB As Color
        Dim PenColor As Pen = Pens.DodgerBlue
        ...
        Select Case MouseState
            Case State.MouseNone
                G.Clear(Color.Gray)
                DrawGradient(GradA, GradB, 0, 0, Width, Height, 90S)
            Case State.MouseOver
                G.Clear(Color.Gray)
                DrawGradient(GradA, GradB, 0, 0, Width, Height, 90S)
            Case State.MouseDown
                G.Clear(Color.DarkGray)
                DrawGradient(GradB, GradA, 0, 0, Width, Height, 90S)
        End Select

        DrawBorders(Pens.Black, PenColor, ClientRectangle)   ' Button Border
        DrawCorners(Color.Black, ClientRectangle)   ' Clean Corners
        DrawText(HorizontalAlignment.Center, Color.White, 0)
    End Sub
End Class ' BetaBlue Button
Class BetaBlueSeperator
    Inherits Control
    ...
    Sub New()
        ...
        C1 = Color.FromArgb(0, 95, 218) 'Background
        P1 = New Pen(Color.FromArgb(55, 55, 55)) 'Shadow
        P2 = New Pen(Color.FromArgb(0, 105, 246)) 'Highlight
    End Sub
