...
Class PaladinTheme
    ...
    Public Property Value() As Integer
        ...
        End Get
        Set(ByVal value As Integer)
            If value > 100 Then _Value = 100 Else If value < 0 Then _Value = 0 Else _Value = value
    ...
    Protected Overrides Sub PaintHook()
        ...
        Dim HeaderLGB As New LinearGradientBrush(New Rectangle(0, 0, Width, 17), Color.FromArgb(230, 230, 230), Color.FromArgb(210, 210, 210), 90S)
        ...
        Dim RecLGB As New LinearGradientBrush(New Point(0, 0), New Point(0, Height), Color.FromArgb(180, 180, 180), Color.FromArgb(200, 200, 200))
    ...
    Private Function CreateRoundRectangle(ByVal rectangle As Rectangle, ByVal radius As Integer, Optional ByVal TopLeft As Boolean = True, Optional ByVal TopRigth As Boolean = True, Optional ByVal BottomRigth As Boolean = True, Optional ByVal BottomLeft As Boolean = True) As GraphicsPath
        ...
        Return path
    End Function
    Public Shared Function ClearOutsidePath(ByVal B As Bitmap, ByVal Path As GraphicsPath) As Bitmap
        Dim C As Color = Color.FromArgb(0, 0, 0, 0)

        Dim TmpB As New Bitmap(B.Width, B.Height)
        Dim G As Graphics = Graphics.FromImage(TmpB)
        G.FillPath(Brushes.Black, Path)
        G.Dispose()

        For x = 0 To B.Width - 1
            For y = 0 To B.Height - 1
                If B.GetPixel(x, y) <> C Then If TmpB.GetPixel(x, y) = C Then B.SetPixel(x, y, C)
            Next
        Next
...
Class PaladinButton
    ...
    Protected Overrides Sub PaintHook()
        ...
        Dim HeaderLGB As New LinearGradientBrush(New Rectangle(0, 0, Width, Height \ 2), Color.FromArgb(230, 230, 230), Color.FromArgb(210, 210, 210), 90S)
        ...
        DrawBorders(New Pen(New SolidBrush(Color.FromArgb(222, 222, 222))), 1, 1, Width - 2, Height - 3) ' up
        DrawBorders(New Pen(New SolidBrush(Color.FromArgb(140, 140, 140))), 0, 0, Width, Height - 1) ' sous
        ...
        If State = MouseState.Over Then
            ...
            Dim HeaderLGB1 As New LinearGradientBrush(New Rectangle(0, 0, Width, Height \ 2), Color.FromArgb(235, 235, 235), Color.FromArgb(215, 215, 215), 90S)
            ...
            DrawBorders(New Pen(New SolidBrush(Color.FromArgb(230, 230, 230))), 1, 1, Width - 2, Height - 3) ' up
            DrawBorders(New Pen(New SolidBrush(Color.FromArgb(140, 140, 140))), 0, 0, Width, Height - 1) ' sous
        ...
        ElseIf State = MouseState.Down Then
            ...
            G.Clear(Color.FromArgb(200, Color.Gainsboro))
            Dim HeaderLGB1 As New LinearGradientBrush(New Rectangle(0, 0, Width, Height \ 2), Color.FromArgb(225, 225, 225), Color.FromArgb(205, 205, 205), 90S)
            G.FillRectangle(HeaderLGB1, 0, 0, Width, Height \ 2)
            G.DrawLine(New Pen(New SolidBrush(Color.FromArgb(210, 210, 210))), 1, Height - 1, Width - 2, Height - 1)


            DrawBorders(New Pen(New SolidBrush(Color.FromArgb(217, 217, 217))), 1, 1, Width - 2, Height - 3) ' up
            DrawBorders(New Pen(New SolidBrush(Color.FromArgb(140, 140, 140))), 0, 0, Width, Height - 1) ' sous
...
Class ControlButton
    ...
    Protected Overrides Sub PaintHook()
        ...
        Dim HeaderLGB As New LinearGradientBrush(New Rectangle(0, 0, Width, Height \ 2), Color.FromArgb(220, 220, 220), Color.FromArgb(180, 180, 180), 90S)
        G.FillRectangle(HeaderLGB, 0, 0, Width, Height \ 2)

        DrawBorders(New Pen(New SolidBrush(Color.FromArgb(130, 130, 130))), 1, 1, Width - 2, Height - 3) ' up

        If State = MouseState.Over Then

            G.Clear(Color.FromArgb(190, Color.Gainsboro))

            Dim HeaderLGB1 As New LinearGradientBrush(New Rectangle(0, 0, Width, Height \ 2), Color.FromArgb(230, 230, 230), Color.FromArgb(190, 190, 190), 90S)
            G.FillRectangle(HeaderLGB1, 0, 0, Width, Height \ 2)

            DrawBorders(New Pen(New SolidBrush(Color.FromArgb(140, 140, 140))), 1, 1, Width - 2, Height - 3) ' up

        ElseIf State = MouseState.Down Then
            G.Clear(Color.FromArgb(175, Color.Gainsboro))

            Dim HeaderLGB1 As New LinearGradientBrush(New Rectangle(0, 0, Width, Height \ 2), Color.FromArgb(215, 215, 215), Color.FromArgb(175, 175, 175), 90S)
            G.FillRectangle(HeaderLGB1, 0, 0, Width, Height \ 2)

            DrawBorders(New Pen(New SolidBrush(Color.FromArgb(125, 125, 125))), 1, 1, Width - 2, Height - 3) ' up
...
Class PaladinCheckBox
    ...
    Protected Overrides Sub PaintHook()
        Dim C3 As Color = Color.FromArgb(150, 150, 150)
        Dim C4 As Color = Color.FromArgb(140, 140, 140)
        ...
        Dim RecLGB As New SolidBrush(Color.FromArgb(180, 180, 180))
        Dim chkRec As New Rectangle(2, 1, Height - 2, Height - 2)
        Dim chkRecInner As New Rectangle(3, 2, Height - 4, Height - 4)
        Dim chkRecInner2 As New Rectangle(4, 3, Height - 6, Height - 6)
        G.FillRectangle(RecLGB, chkRec)
        Dim P2 As Pen = New Pen(Color.FromArgb(90, 90, 90))
        Dim P3 As Pen = New Pen(Color.FromArgb(235, 235, 235))
        Dim P4 As Pen = New Pen(Color.FromArgb(145, 145, 145))
...
Class PalaDinGroupeBox
    ...
    Protected Overrides Sub PaintHook()
        ...
        Dim HeaderLGB As New LinearGradientBrush(New Rectangle(2, 2, Width - 5, 11), Color.FromArgb(210, 210, 210), Color.FromArgb(190, 190, 190), 90S)
        G.FillRectangle(HeaderLGB, New Rectangle(2, 2, Width - 5, 10))

        ''
        Dim DownLGB As New LinearGradientBrush(New Rectangle(0, -1, Width - 2, 20), Color.FromArgb(60, Color.White), Color.FromArgb(20, Color.White), 90S)
        ...
        G.DrawLine(New Pen(New SolidBrush(Color.FromArgb(90, 90, 90))), 1, 145, Width - 2, 145) 'InnerButtumline
