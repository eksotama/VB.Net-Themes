...
Class clsAnomTheme
    ...
    Protected Overrides Sub PaintHook()
        ...
        Else
            TextXPos = 6
        End If
        G.DrawString(FindForm.Text, Font, TextBrush, New Point(TextXPos, 10))
...
Class AnomButton
    ...
    Protected Overrides Sub PaintHook()
        ...
        Dim LGBNone As New LinearGradientBrush(New Rectangle(1, 1, Width - 2, Height - 2), Color.FromArgb(255, 222, 222, 222), Color.FromArgb(255, 200, 200, 200), 90.0F)
        Dim LGBDown As New LinearGradientBrush(New Rectangle(1, 1, Width - 2, Height - 2), Color.FromArgb(255, 200, 200, 200), Color.FromArgb(255, 222, 222, 222), 90.0F)
        ...
        End Select
        Dim HB As New HatchBrush(HatchStyle.LightDownwardDiagonal, Color.FromArgb(80, Color.Gray), Color.Transparent)
        G.FillRectangle(HB, New Rectangle(1, 1, Width - 2, Height - 2))
...
Class AnomGroupBox
    ...
    Protected Overrides Sub PaintHook()
        G.Clear(BackColor)
        Dim LGB As New LinearGradientBrush(New Rectangle(1, 1, Width - 2, Height - 1), Color.FromArgb(255, 222, 222, 222), Color.FromArgb(255, 200, 200, 200), 90.0F)
        Dim HB As New HatchBrush(HatchStyle.LightDownwardDiagonal, Color.FromArgb(80, Color.Gray), Color.Transparent)
...
Class AnomCheckBox
    ...
    Protected Overrides Sub PaintHook()
        ...
        Dim HB As New HatchBrush(HatchStyle.LightDownwardDiagonal, Color.FromArgb(80, Color.Gray), Color.Transparent)
        Dim LGB As New LinearGradientBrush(New Rectangle(1, 1, 16, 16), Color.FromArgb(255, 222, 222, 222), Color.FromArgb(255, 200, 200, 200), 90.0F)
...
Class AnomTrippleCheckBox
    ...
    Protected Overrides Sub OnClick(ByVal e As System.EventArgs)
        ...
        If (_Checked = 0) Then
            _Checked = 1
        ElseIf (_Checked = 1) Then
            Checked = 2
        ElseIf (_Checked = 2) Then
            _Checked = 0
        End If
...
Class AnomRadiobutton
    ...
    Protected Overrides Sub OnClick(ByVal e As System.EventArgs)
        ...
        For Each C As Control In Parent.Controls
            If C.GetType.ToString = Replace(My.Application.Info.ProductName, " ", "_") & ".AnomRadiobutton" Then
                Dim CC As AnomRadiobutton
                CC = C
                CC.Checked = False
            Else
