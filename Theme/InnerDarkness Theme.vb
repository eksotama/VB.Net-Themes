...
#Region " Convienence "
    ...
    Protected Sub DrawBG(ByVal c As Color, ByVal rect As Rectangle)
        DrawGradient(Color.FromArgb(43, 255, 255, 255), Color.Black, 0, 0, Me.Width / 2, Me.Height / 2, 45)
        DrawGradient(Color.FromArgb(43, 255, 255, 255), Color.Black, Me.Width / 2, 0, Me.Width / 2, Me.Height / 2, 135)
        DrawGradient(Color.FromArgb(43, 255, 255, 255), Color.Black, 0, Me.Height / 2, Me.Width / 2, Me.Height / 2, 315)
        DrawGradient(Color.FromArgb(43, 255, 255, 255), Color.Black, Me.Width / 2, Me.Height / 2, Me.Width / 2, Me.Height / 2, 225)
    End Sub
...
Class InDButton
    ...
    Public Overrides Sub PaintHook()
        If MouseState = State.MouseDown Then
            DrawGradient(Color.DarkGray, Color.DimGray, 0, 0, Width, Height, 90S)
        ElseIf MouseState = State.MouseOver Then
            DrawGradient(Color.DarkGray, Color.DarkGray, 0, 0, Width, Height, 90S)
        Else
...
Class InDProgressBar
    ...
    Overrides Sub PaintHook()
        G.Clear(Color.Gray)
        If (_Value > 0) Then
            DrawGradient(Color.DimGray, Color.Black, 0, 0, CInt((_Value / _Maximum) * Width), Height, 90S)
        End If
