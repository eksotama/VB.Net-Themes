...
Class HFxTheme
    ...
    Public Overrides Sub PaintHook()
        ...
        G.Clear(Color.Gray)
        DrawGradient(Color.Gray, Color.Purple, 0, 0, Width, 25, 90S)
        ...
        DrawBorders(Pens.Purple, Pens.Purple, ClientRectangle)   ' Then we draw our form borders

        DrawText(HorizontalAlignment.Left, Color.White, 7, 1)   ' Finally, we draw our text
    End Sub
    ...
    Overrides Sub PaintHook()
        Select Case MouseState
            ...
            Case State.MouseOver
                DrawGradient(Color.Gray, Color.Purple, 0, 0, Width, Height, 90S)

            Case State.MouseDown
                DrawGradient(Color.Purple, Color.Gray, 0, 0, Width, Height, 90S)
        End Select

        DrawBorders(Pens.Black, Pens.Purple, ClientRectangle)   ' Form Border
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        Using b As New Bitmap(Width, Height)
            Using g As Graphics = Graphics.FromImage(b)
                ...
                Dim P1 As Color = Color.Purple
                Dim P2 As Color = Color.Purple
...
Class HFxGroupbox
    Inherits Panel
    Dim Bg As Color = Color.Gray
    Dim PC2 As Color = Color.White
