...
'Author:   TheDarky
'Credits:  Aeonhack [Themebase and Tutorials :)]
'Version:  0.1
...
Class eTheme
    ...
    Overrides Sub PaintHook()
        ...
        DrawGradient(Color.FromArgb(50, 50, 50), Color.FromArgb(50, 50, 50), 0, 1, Width, 14, 90S)
        DrawGradient(Color.FromArgb(29, 29, 29), Color.FromArgb(29, 29, 29), 2, 16, Width, 14, 90S)
    ...
    Overrides Sub PaintHook()
        Select Case MouseState
            Case State.MouseNone
                ...
                DrawGradient(Color.FromArgb(50, 50, 50), Color.FromArgb(40, 40, 40), ClientRectangle.X, ClientRectangle.Y, ClientRectangle.Width, ClientRectangle.Height, 90S)
            Case State.MouseDown
                G.Clear(Color.FromArgb(49, 49, 49))
                DrawGradient(Color.FromArgb(40, 40, 40), Color.FromArgb(50, 50, 50), ClientRectangle.X, ClientRectangle.Y, ClientRectangle.Width, ClientRectangle.Height, 90S)
            Case State.MouseOver
                G.Clear(Color.FromArgb(49, 49, 49))
                DrawGradient(Color.FromArgb(60, 60, 60), Color.FromArgb(50, 50, 50), ClientRectangle.X, ClientRectangle.Y, ClientRectangle.Width, ClientRectangle.Height, 90S)
        End Select
        DrawText(HorizontalAlignment.Center, Color.Gray, 0)
