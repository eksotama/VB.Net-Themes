...
Class YTTheme
    ...
    Overrides Sub PaintHook()
        G.Clear(BackColor)
        DrawGradient(Color.DarkRed, Color.Red, 0, 0, Width, 20, 90S)
        DrawGradient(Color.White, Color.LightGray, 0, 20, Width, Height - 25, 90S)
        DrawGradient(Color.DarkRed, Color.Red, 0, Height - 25, Width, Height + 25 - Height, 90S)
        DrawGradient(Color.DarkRed, Color.Red, 0, Height + 25 - Height - 5, 10, Height - 45, 180S)
        DrawGradient(Color.Red, Color.DarkRed, Width - 10, Height + 25 - Height - 5, 10, Height - 45, 180S)
...
Class YTButton
    ...
    Public Overrides Sub PaintHook()
        If MouseState = State.MouseDown Then
            DrawGradient(Color.Red, Color.DarkRed, 0, 0, Width, Height, 90S)
        ElseIf MouseState = State.MouseOver Then
            DrawGradient(Color.DarkRed, Color.Red, 0, 0, Width, Height, 90S)
        Else
            DrawGradient(Color.Red, Color.DarkRed, 0, 0, Width, Height, 90S)
        End If
...
Class YTProgressBar
    ...
    Overrides Sub PaintHook()
        ...
        If (_Value > 0) Then
            DrawGradient(Color.Red, Color.DarkRed, 0, 0, CInt((_Value / _Maximum) * Width), Height, 90S)
        End If
