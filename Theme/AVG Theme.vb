...
Class AVGTheme
    'Credits!
    'Theme Created By : Stealth
    'ThemeBase 1.5.4 Created By AeonHack
    'Thanks to Mavamaartan for GhostTextBox and his tutorial!
    ...
    Protected Overrides Sub PaintHook()
        ...
        Select Case State
            Case MouseState.None
                ...
                DrawText(TextColor, HorizontalAlignment.Left, 0, 0)
            Case MouseState.Over
                G.FillRectangle(New SolidBrush(Color.FromArgb(255, 78, 19)), New Rectangle(0, 0, Width - 1, Height - 1))
                G.DrawRectangle(Border, New Rectangle(0, 0, Width - 1, Height - 1))
                DrawText(TextColor, HorizontalAlignment.Left, 0, 0)
        End Select
    End Sub
...
Class AVGTextBox
    ...
    Sub New()
        ...
        SetColor("Text", Color.WhiteSmoke)
        SetColor("Back", 39, 43, 57)
        SetColor("Border1", 24, 143, 124)
