...
Class ThemeControl
    ...
    Protected Overrides Sub PaintHook()
        ...
        Dim HB As New HatchBrush(HatchStyle.BackwardDiagonal, Color.FromArgb(25, Color.White), Color.Transparent)
...
Class ProgressBar
    ...
    Protected Overrides Sub PaintHook()
        G.Clear(BackColor)
        Dim HB As New HatchBrush(HatchStyle.BackwardDiagonal, Color.FromArgb(15, Color.LightBlue), Color.Transparent)
        G.FillRectangle(Prog, 0, 0, CInt(_Value / _Maximum * Width), Height)
        G.FillRectangle(HB, New Rectangle(0, 0, CInt(_Value / _Maximum * Width), Height))
        DrawGradient(Color.FromArgb(40, Color.White), Color.FromArgb(10, Color.White), ClientRectangle)
        DrawBorders(Pens.Black, ClientRectangle)
    End Sub
