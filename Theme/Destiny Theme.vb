...
Class Destiny_Theme
    ...
    Private _Somthing As Integer
    Property Somthing() As Integer
        Get
            Return _Somthing
        End Get
    ...
    Sub New()
        ...
        Dim F As New Font("Verdana", 7) : Font = F
    End Sub
    Public Overrides Sub PaintHook()
        G.Clear(BackColor)

        DrawGradient(Color.Teal, Color.Black, 0, 0, Width, 20, 90S)
...
Class Destiny_Button
    Inherits ThemeControl


    Dim G1 As Color = Color.Teal : Dim G2 As Color = Color.Black : Dim G3 As Color = Color.Black
    Dim G4 As Color = Color.Teal : Dim Bl As Pen = Pens.Black : Dim G5 As Color = Color.Teal
    Dim N As Color = BackColor
    ...
    Overrides Sub PaintHook()
        ...
        ElseIf MouseState = State.MouseOver Then
            DrawGradient(G3, G5, 0, 0, Width, Height, 90S)
        ElseIf MouseState = State.MouseDown Then
            DrawGradient(G4, G4, 0, 0, Width, Height, 90S)
        End If
...
Class Destiny_Bar
    ...
    Dim Border As New Pen(Color.FromArgb(82, 128, 145)) : Dim T As Color = Color.Transparent
    Dim BackClr As Color = Color.Black : Dim UpperColor As New SolidBrush(Color.Teal) : Dim LowerColor As New SolidBrush(Color.DarkCyan)
...
Class Destiny_Separator
    Inherits ThemeControl

    Private _Color1 As Color = Color.Teal
...
Class Destiny_MenuButton
    ...
    Dim G1 As Color = Color.Teal : Dim G2 As Color = Color.Black
