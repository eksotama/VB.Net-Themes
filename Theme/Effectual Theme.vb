...
Public Class ImageToCodeClass
    ...
    End Function
End Class
Public Class EffectualButtonBlue : Inherits Control
#Region " MouseStates "
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        Select Case State
            Case MouseState.None
                Dim lgb As New LinearGradientBrush(ClientRectangle, Color.FromArgb(123, 190, 216), Color.FromArgb(108, 175, 201), 90S)
                G.FillPath(lgb, Draw.RoundRect(ClientRectangle, 2))
                Dim p As New Pen(New SolidBrush(Color.FromArgb(60, 113, 132)))
                G.DrawPath(p, Draw.RoundRect(ClientRectangle, 2))
                Dim Ip As New Pen(Color.FromArgb(75, Color.White))
                G.DrawPath(Ip, Draw.RoundRect(InnerRect, 2))
            Case MouseState.Over
                Dim lgb As New LinearGradientBrush(ClientRectangle, Color.FromArgb(113, 180, 206), Color.FromArgb(114, 181, 207), 90S)
                G.FillPath(lgb, Draw.RoundRect(ClientRectangle, 2))
                Dim p As New Pen(New SolidBrush(Color.FromArgb(60, 113, 132)))
                G.DrawPath(p, Draw.RoundRect(ClientRectangle, 2))
                Dim Ip As New Pen(Color.FromArgb(75, Color.White))
        ...
        G.DrawString(Text, drawFont, New SolidBrush(Color.White), New Rectangle(0, 1, Width - 1, Height - 1), New StringFormat() With {.Alignment = StringAlignment.Center, .LineAlignment = StringAlignment.Center})

        e.Graphics.DrawImage(B.Clone(), 0, 0)
        G.Dispose() : B.Dispose()
    End Sub
End Class
Public Class EffectualButtonOrange : Inherits Control
#Region " MouseStates "
    Dim State As MouseState = MouseState.None
    Protected Overrides Sub OnMouseDown(ByVal e As System.Windows.Forms.MouseEventArgs)
        MyBase.OnMouseDown(e)
...
#End Region
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        Select Case State
            Case MouseState.None
                Dim lgb As New LinearGradientBrush(ClientRectangle, Color.FromArgb(214, 162, 68), Color.FromArgb(199, 147, 53), 90S)
                G.FillPath(lgb, Draw.RoundRect(ClientRectangle, 2))

                Dim p As New Pen(New SolidBrush(Color.FromArgb(142, 107, 46)))
                G.DrawPath(p, Draw.RoundRect(ClientRectangle, 2))
                Dim Ip As New Pen(Color.FromArgb(75, Color.White))
                G.DrawPath(Ip, Draw.RoundRect(InnerRect, 2))
            Case MouseState.Over
                Dim lgb As New LinearGradientBrush(ClientRectangle, Color.FromArgb(204, 152, 58), Color.FromArgb(205, 153, 59), 90S)
                G.FillPath(lgb, Draw.RoundRect(ClientRectangle, 2))
                Dim p As New Pen(New SolidBrush(Color.FromArgb(142, 107, 46)))
                G.DrawPath(p, Draw.RoundRect(ClientRectangle, 2))
                Dim Ip As New Pen(Color.FromArgb(75, Color.White))
    ...
    End Sub
End Class
Public Class EffectualButtonGray : Inherits Control
#Region " MouseStates "
    Dim State As MouseState = MouseState.None
    Protected Overrides Sub OnMouseDown(ByVal e As System.Windows.Forms.MouseEventArgs)
        MyBase.OnMouseDown(e)
...
#End Region
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        Select Case State
            Case MouseState.None
                Dim lgb As New LinearGradientBrush(ClientRectangle, Color.FromArgb(203, 201, 205), Color.FromArgb(188, 186, 190), 90S)
                G.FillPath(lgb, Draw.RoundRect(ClientRectangle, 2))
                ...
                G.DrawPath(Ip, Draw.RoundRect(InnerRect, 2))
            Case MouseState.Over
                Dim lgb As New LinearGradientBrush(ClientRectangle, Color.FromArgb(193, 191, 195), Color.FromArgb(194, 192, 196), 90S)
                G.FillPath(lgb, Draw.RoundRect(ClientRectangle, 2))
                Dim p As New Pen(New SolidBrush(Color.FromArgb(117, 120, 117)))
                G.DrawPath(p, Draw.RoundRect(ClientRectangle, 2))
                Dim Ip As New Pen(Color.FromArgb(75, Color.White))
        ...
        G.DrawString(Text, drawFont, New SolidBrush(Color.FromArgb(50, 50, 50)), New Rectangle(0, 1, Width - 1, Height - 1), New StringFormat() With {.Alignment = StringAlignment.Center, .LineAlignment = StringAlignment.Center})

        e.Graphics.DrawImage(B.Clone(), 0, 0)
        G.Dispose() : B.Dispose()
    End Sub
End Class
Public Class EffectualTheme : Inherits ContainerControl
    Sub New()
        SetStyle(ControlStyles.UserPaint Or ControlStyles.SupportsTransparentBackColor, True)
        BackColor = Color.FromArgb(25, 25, 25)
        DoubleBuffered = True
    End Sub
    Dim _SubText As String
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        Dim B As New Bitmap(Width, Height)
        Dim G As Graphics = Graphics.FromImage(B)
        Dim MainBox As New Rectangle(0, 0, Width, 32)
        Dim SecondBox As New Rectangle(0, 33, Width, Height)
        Dim BottomBox As New Rectangle(-3, Height - 25, Width + 5, Height - 25)
    ...
    Protected Overrides Sub OnCreateControl()
        ...
        Me.ParentForm.FormBorderStyle = FormBorderStyle.Sizable
        Me.ParentForm.ShowIcon = False
        Me.ParentForm.TransparencyKey = Color.Fuchsia
        Dock = DockStyle.Fill
    End Sub
End Class
Public Class EffectualGroupBox : Inherits ContainerControl
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        Dim B As New Bitmap(Width, Height)
        Dim G As Graphics = Graphics.FromImage(B)
        Dim Body As New Rectangle(0, 0, Width - 1, Height - 1)
        ...
        G.DrawString(Text, t, New SolidBrush(Color.FromArgb(40, 40, 40)), New Rectangle(0, 1, Width - 1, 25), New StringFormat() With {.Alignment = StringAlignment.Center, .LineAlignment = StringAlignment.Center})

        Dim UnderlineBrush As New SolidBrush(Color.FromArgb(126, 126, 126))
        Dim UnderlinePen As New Pen(UnderlineBrush, 3)
        G.DrawLine(UnderlinePen, 20, 24, Width - 20, 24)
        Dim UnderlinePen2 As New Pen(UnderlineBrush, 1)
    ...
    End Sub
End Class
Public Class EffectualProgressBarBlue : Inherits Control
...
#End Region
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        Dim gB As New LinearGradientBrush(New Rectangle(0, 0, Width - 1, Height - 1), Color.FromArgb(203, 201, 205), Color.FromArgb(188, 186, 190), 90S)
        ...
        Dim g1 As New LinearGradientBrush(New Rectangle(2, 2, intValue - 1, Height - 2), Color.FromArgb(123, 190, 216), Color.FromArgb(108, 175, 201), 90S)
        ...
        G.DrawPath(New Pen(Color.FromArgb(60, 113, 132)), Draw.RoundRect(New Rectangle(0, 0, intValue - 1, Height - 1), 2)) 'colored bar outline
    ...
    End Sub
End Class
Public Class EffectualProgressBarOrange : Inherits Control
...
#End Region
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        G.FillPath(gB, Draw.RoundRect(New Rectangle(0, 0, Width - 1, Height - 1), 1))
        G.DrawPath(New Pen(New SolidBrush(Color.FromArgb(75, Color.White))), Draw.RoundRect(New Rectangle(1, 1, Width - 3, Height - 3), 1))
        Dim g1 As New LinearGradientBrush(New Rectangle(2, 2, intValue - 1, Height - 2), Color.FromArgb(214, 162, 68), Color.FromArgb(199, 147, 53), 90S)
        G.FillPath(g1, Draw.RoundRect(New Rectangle(0, 0, intValue - 1, Height - 2), 1))
        Dim h1 As New HatchBrush(HatchStyle.DarkUpwardDiagonal, Color.FromArgb(40, Color.White), Color.FromArgb(20, Color.White))
        G.FillPath(h1, Draw.RoundRect(New Rectangle(0, 0, intValue - 1, Height - 2), 1))
    ...
    End Sub
End Class
<DefaultEvent("CheckedChanged")> Public Class EffectualCheckBox : Inherits Control
...
#End Region
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        Dim bodyGrad As New LinearGradientBrush(checkBoxRectangle, Color.FromArgb(203, 201, 205), Color.FromArgb(188, 186, 190), 90S)
        ...
        If Checked Then
            ...
            G.DrawString("a", t, Brushes.Black, -1.5, 0)
        End If

        Dim drawFont As New Font("Tahoma", 8, FontStyle.Bold)
        Dim nb As Brush = New SolidBrush(Color.FromArgb(40, 40, 40))
...
End Class
<DefaultEvent("CheckedChanged")> Public Class EffectualRadioButton : Inherits Control
...
#Region " Control Help - MouseState & Flicker Control"
    ...
    Private Sub InvalidateControls()
        ...
        For Each C As Control In Parent.Controls
            If C IsNot Me AndAlso TypeOf C Is EffectualRadioButton Then
                DirectCast(C, EffectualRadioButton).Checked = False
            End If
        Next
    End Sub
#End Region
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        Dim bgGrad As New LinearGradientBrush(radioBtnRectangle, Color.FromArgb(203, 201, 205), Color.FromArgb(188, 186, 190), 90S)
        ...
        If Checked Then
            Dim t As New Font("Marlett", 8, FontStyle.Bold)
