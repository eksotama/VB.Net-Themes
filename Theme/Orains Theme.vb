...
Class OrainsTheme
    ...
    Sub New()
        ...
        SetColor("Header", Color.FromArgb(22, 22, 22)) ' Form Header Effect
        SetColor("G1", 14, 14, 14) ' Gradiant Color 1 Top
        SetColor("G2", 20, 20, 20) ' Gradiant Color 2 Bottom
    End Sub

    Dim Border, TextColor, R1, R2 As Color
    Dim InnerBorder As Color
    Dim outerborder As Pen
    Dim BGColor, HeaderC As Brush
    ...
    Protected Overrides Sub PaintHook()
        ...
        Dim LGB As New LinearGradientBrush(New Rectangle(0, 0, Width - 1, Height - 1), R1, R2, -90S)
        G.FillRectangle(LGB, New Rectangle(0, 0, Width - 1, Height - 1))


        Dim BodyHatch As New HatchBrush(HatchStyle.DarkUpwardDiagonal, Color.FromArgb(75, Color.Black), Color.Transparent)
        ...
        G.DrawRectangle(outerborder, New Rectangle(0, 0, Width - 1, Height - 1)) ' OuterBorder of BackColor
        ...
        G.DrawRectangle(New Pen(InnerBorder), New Rectangle(1, 1, Width - 3, Height - 3)) 'InnerBorder of BackCOlor' 
...
Class OrainsButton
    ...
    Sub New()
        ...
        SetColor("Header", Color.FromArgb(40, 40, 40)) ' Form Header Effect
    End Sub
    Dim ButtonColor1, ButtonColor2 As Color
    Dim InnerBorder As Color
    Dim TextColor, Header As Brush
    Dim OuterBorder As Pen
    ...
    Protected Overrides Sub PaintHook()
        ...
        Select Case State
            Case MouseState.None
                ...
                Dim LGB As New LinearGradientBrush(New Rectangle(0, 0, Width - 1, Height - 1), ButtonColor1, ButtonColor2, 90S)
                G.FillRectangle(LGB, New Rectangle(0, 0, Width - 1, Height - 1))
                Dim BodyHatch As New HatchBrush(HatchStyle.DarkUpwardDiagonal, Color.FromArgb(30, Color.Black), Color.Transparent)
                G.FillRectangle(BodyHatch, New Rectangle(0, 0, Width - 1, Height - 1))
            ...
            Case MouseState.Over
                ...
                Dim LGB As New LinearGradientBrush(New Rectangle(0, 0, Width - 1, Height - 1), ButtonColor1, Color.FromArgb(20, 20, 20), 90S)
                G.FillRectangle(LGB, New Rectangle(0, 0, Width - 1, Height - 1))
                Dim BodyHatch As New HatchBrush(HatchStyle.DarkUpwardDiagonal, Color.FromArgb(30, Color.Black), Color.Transparent)
                G.FillRectangle(BodyHatch, New Rectangle(0, 0, Width - 1, Height - 1))
            ...
            Case MouseState.Down
                Dim LGB As New LinearGradientBrush(New Rectangle(0, 0, Width - 1, Height - 1), Color.FromArgb(20, 20, 20), ButtonColor2, 90S)
                G.FillRectangle(LGB, New Rectangle(0, 0, Width - 1, Height - 1))
                Dim BodyHatch As New HatchBrush(HatchStyle.DarkUpwardDiagonal, Color.FromArgb(30, Color.Black), Color.Transparent)
                G.FillRectangle(BodyHatch, New Rectangle(0, 0, Width - 1, Height - 1))
...
Class OrainsRadioButton
    ...
    Private Sub InvalidateControls()
        ...
        For Each C As Control In Parent.Controls
            If C IsNot Me AndAlso TypeOf C Is OrainsRadioButton Then
                DirectCast(C, OrainsRadioButton).Checked = False
            End If
        Next
    End Sub
    ...
    Dim CircleColor, CircleInner As Pen
...
Class OrainsComboBox ' Credits Mavamaarten For the ComboBox Code =))
    Inherits ComboBox
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        Dim S1 As Integer = G.MeasureString("OrainsComboBox", Font).Height
        If SelectedIndex <> -1 Then
            G.DrawString(Items(SelectedIndex), Font, New SolidBrush(Color.Orange), 4, Height \ 2 - S1 \ 2)
        Else
            If Not Items Is Nothing And Items.Count > 0 Then
                G.DrawString(Items(0), Font, New SolidBrush(Color.Orange), 4, Height \ 2 - S1 \ 2)
            Else
    ...
    Protected Overrides Sub OnDrawItem(ByVal e As DrawItemEventArgs)
        ...
        If e.State = 785 Or e.State = 17 Then
            ...
            Dim x2 As Rectangle = New Rectangle(e.Bounds.Location, New Size(e.Bounds.Width + 2, e.Bounds.Height))
            Dim x3 As Rectangle = New Rectangle(x2.Location, New Size(x2.Width, (x2.Height / 2) - 1))
            Dim G1 As New LinearGradientBrush(New Point(x2.X, x2.Y), New Point(x2.X, x2.Y + x2.Height), Color.FromArgb(255, 128, 0), Color.FromArgb(153, 76, 0))
            Dim H As New HatchBrush(HatchStyle.DarkUpwardDiagonal, Color.FromArgb(15, Color.Black), Color.Transparent)
...
Class OrainsListBox
    ...
    Protected Overrides Sub OnDrawItem(ByVal e As System.Windows.Forms.DrawItemEventArgs)
        Try
            ...
            If InStr(e.State.ToString, "Selected,") > 0 Then
                ...
                Dim G1 As New LinearGradientBrush(New Point(x2.X, x2.Y), New Point(x2.X, x2.Y + x2.Height), Color.FromArgb(255, 128, 0), Color.FromArgb(153, 76, 0))
                Dim H As New HatchBrush(HatchStyle.DarkUpwardDiagonal, Color.FromArgb(10, Color.Black), Color.Transparent)
                e.Graphics.FillRectangle(G1, x2) : G1.Dispose()
                e.Graphics.FillRectangle(New SolidBrush(Color.FromArgb(25, Color.White)), x3)
                e.Graphics.FillRectangle(H, x2) : G1.Dispose()
                e.Graphics.DrawString(" " & Items(e.Index).ToString(), Font, Brushes.Black, e.Bounds.X, e.Bounds.Y + 1)
    ...
    End Sub
End Class
Class OrainsControlBox : Inherits Control
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        G.Clear(BackColor)
        Dim ButtonFont As New Font("Marlett", 9)
        G.DrawString("r", ButtonFont, New SolidBrush(Color.FromArgb(90, 90, 90)), New Point(Width - 16, 7), New StringFormat With {.Alignment = StringAlignment.Center})

        G.DrawString("0", ButtonFont, New SolidBrush(Color.FromArgb(90, 90, 90)), New Point(22, 7), New StringFormat With {.Alignment = StringAlignment.Center})
        ...
        Select Case ButtonState
            ...
            Case ButtonHover.Minimize
                ...
                Dim BodyHatch As New HatchBrush(HatchStyle.DarkUpwardDiagonal, Color.FromArgb(15, Color.White), Color.Transparent)
                ...
                G.DrawString("0", ButtonFont, New SolidBrush(Color.Cyan), New Point(22, 7), New StringFormat With {.Alignment = StringAlignment.Center})
            Case ButtonHover.Close
                ...
                G.DrawString("r", ButtonFont, New SolidBrush(Color.Red), New Point(Width - 16, 7), New StringFormat With {.Alignment = StringAlignment.Center})
...
Class OrainsGroupBox
    ...
    Protected Overrides Sub PaintHook()
        ...
        Dim LGB1 As New LinearGradientBrush(New Rectangle(0, 0, Width - 1, Height - 1), R1, R2, 90S)
        G.FillRectangle(LGB1, New Rectangle(0, 0, Width - 1, Height - 25))

        Dim BodyHatch As New HatchBrush(HatchStyle.NarrowVertical, Color.FromArgb(15, Color.White), Color.Transparent)
        G.FillRectangle(BodyHatch, New Rectangle(0, 0, Width - 1, Height - 1))
        ...
        G.FillRectangle(New SolidBrush(Color.FromArgb(20, 20, 20)), New Rectangle(1, 26, Width - 2, Height - 27)) ' BG
...
Class OrainsProgressBar
    ...
    Sub New()
        ...
        Blend.Colors = New Color() {Color.FromArgb(153, 76, 0), Color.FromArgb(195, 97, 0), Color.FromArgb(195, 97, 0), Color.FromArgb(153, 76, 0)}
    ...
    Protected Overrides Sub PaintHook()
        ...
        DrawGradient(Color.FromArgb(20, 20, 20), Color.FromArgb(20, 20, 20), 2, 2, Width - 4, Height - 4, 90.0F)
...
Class OrainsSeperator
    ...
    Protected Overrides Sub PaintHook()
        ...
        Else
            DrawGradient(BL2, 0, 6, Width, 1, 0.0F)
            DrawGradient(BL1, 0, 7, Width, 1, 0.0F)
        End If
