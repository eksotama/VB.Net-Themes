...
Class theme
    ...
    Protected Overrides Sub PaintHook()
        ...
        Dim LB As New LinearGradientBrush(New Rectangle(New Point(1, 1), New Size(Width - 2, 25)), Color.FromArgb(35, 35, 35), Color.FromArgb(50, 50, 50), 90.0F)
...
Class topbuttons
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
                        ...
                        MyBase.OnPaint(e)
        Dim p As Brush = New SolidBrush(Color.FromArgb(156, 200, 205))
        Dim pa As Brush = New SolidBrush(Color.FromArgb(35, 35, 35))
        Dim ps As Pen = New Pen(Color.FromArgb(156, 200, 205))
        Dim pss As Pen = New Pen(Color.FromArgb(35, 35, 35))
    ...
    Public Sub Form1_Mouseclick(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles MyBase.MouseClick
        Dim posX, posY As New CoordinateSpace
        Dim g As Graphics
        posX = e.X
        Dim CloseArea As New Rectangle(Width - 12, 3, 6, 6) ' close area

        posY = e.Y

        g = Me.CreateGraphics ' I give it drawing object which is aform

        If CloseArea.Contains(posX, posY) Then
        ...
        End If
        ' minimize
        Dim posXx, posYy As New CoordinateSpace

        posXx = e.X
        Dim min As New Rectangle(Width - 42, 3, 6, 6) ' min

        posYy = e.Y

        g = Me.CreateGraphics ' I give it drawing object which is aform

        If min.Contains(posXx, posYy) Then
        ...
        'max
        Dim posXxx, posYyy As New CoordinateSpace

        posXxx = e.X
        Dim max As New Rectangle(Width - 27, 3, 6, 6) ' min

        posYyy = e.Y

        g = Me.CreateGraphics ' I give it drawing object which is aform

        If max.Contains(posXxx, posYyy) Then
...
Class button
    ...
    Sub New()
        ...
        SetColor("Gradient 1", 40, 40, 40)
        SetColor("Gradient 2", 45, 45, 45)
        SetColor("Glow", 50, 50, 50)
        SetColor("Edge", 60, 60, 60)
        SetColor("Text", Color.White)
        SetColor("HoverColor", 10, 10, 10)
...
Public Class Seperator
    ...
    Dim C1 As Color = Color.FromArgb(246, 246, 246)
    Dim C2 As Color = Color.FromArgb(140, 140, 140)
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
...
Class GroupBoxx
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        G.DrawRectangle(ToPen(150, 150, 150), New Rectangle(0, CInt(G.MeasureString(Text, Font).Height / 2), Width - 1, Height - 1 - CInt(G.MeasureString(Text, Font).Height / 2)))
        ...
        G.FillRectangle(ToBrush(246, 246, 246), New Rectangle(New Point(TOff, 0), G.MeasureString(Text, Font).ToSize))
...
Class ComboBoxx
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        DrawCornersBrush = ToBrush(20, 20, 20)
        Try
            With G
                G.SmoothingMode = SmoothingMode.HighQuality
                .Clear(Color.FromArgb(20, 20, 20))
                .FillRectangle(T, New Rectangle(0, 0, Width, Height))
                .DrawLine(ToPen(20, 20, 20), 0, 0, 0, 0)
                .DrawRectangle(ToPen(70, 70, 70), New Rectangle(1, 1, Width - 3, Height - 3))

                .DrawLine(ToPen(80, Color.White), New Point(Width - 22, 4), New Point(Width - 22, Height - 5))
                ...
                Try
                    If .MeasureString(Text, Font).Width > Width - 29 Then
                        ...
                        .DrawString("...", Font, ToBrush(230, 230, 230), New Point(Width - 38, 3))
                    Else
                        .DrawString(Items(SelectedIndex).ToString, Font, ToBrush(71, 71, 71), New RectangleF(3, 3, Width - 35, Height - 7))
                    End If
                Catch
                    .DrawString("...", Font, ToBrush(230, 230, 230), New Point(3, 3))
                End Try
...
Class UTextBox
    ...
    Sub New()
        ...
        SetColor("Text", Color.Black)
        SetColor("Backcolor", 240, 240, 240)
...
Class UTabControl
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        Dim B As New Bitmap(Width, Height)
        Dim G As Graphics = Graphics.FromImage(B)
        Try : SelectedTab.BackColor = Color.FromArgb(246, 246, 246) : Catch : End Try
        G.Clear(Backcolor)
        G.DrawRectangle(New Pen(Color.FromArgb(30, 30, 30)), New Rectangle(0, 10, Width - 1, Height - 2))
        ...
        For i = 0 To TabCount - 1
            ...
            Else
                ...
                Dim G1 As New LinearGradientBrush(x2, Color.FromArgb(30, 30, 30), Color.FromArgb(30, 30, 30), -90.0F)
                G.FillRectangle(G1, x2) : G1.Dispose()
                G.DrawRectangle(New Pen(Color.FromArgb(30, 30, 30)), x2)
