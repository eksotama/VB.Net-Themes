...
Class ETheme
    ...
    Overrides Sub PaintHook()
        ...
        DrawGradient(Color.LightGray, Color.Gray, 0, 0, Width, 20, 90S)
        DrawGradient(Color.LightGray, Color.DimGray, 0, 20, Width, Height - 25, 90S)
        DrawGradient(Color.LightGray, Color.Gray, 0, Height - 25, Width, Height + 25 - Height, 90S)
        DrawGradient(Color.LightGray, Color.Gray, 0, Height + 25 - Height - 5, 10, Height - 45, 180S)
        DrawGradient(Color.LightGray, Color.Gray, Width - 10, Height + 25 - Height - 5, 10, Height - 45, 180S)
...
Class EButton
    ...
    Public Overrides Sub PaintHook()
        ...
        Else
            DrawGradient(Color.LightGray, Color.Gray, 0, 0, Width, Height, 90S)
        End If
...
Class EProgressBar
    ...
    Overrides Sub PaintHook()
        ...
        If (_Value > 0) Then
            DrawGradient(Color.LightGray, Color.Gray, 0, 0, CInt((_Value / _Maximum) * Width), Height, 90S)
        End If
