...
#Region " Convienence "
    ...
    Protected Sub DrawBG(ByVal c As Color, ByVal rect As Rectangle)
        DrawGradient(Color.FromArgb(43, 255, 255, 255), Color.PowderBlue, 0, 0, Me.Width / 2, Me.Height / 2, 45)
        DrawGradient(Color.FromArgb(43, 255, 255, 255), Color.PowderBlue, Me.Width / 2, 0, Me.Width / 2, Me.Height / 2, 135)
        DrawGradient(Color.FromArgb(43, 255, 255, 255), Color.PowderBlue, 0, Me.Height / 2, Me.Width / 2, Me.Height / 2, 315)
        DrawGradient(Color.FromArgb(43, 255, 255, 255), Color.PowderBlue, Me.Width / 2, Me.Height / 2, Me.Width / 2, Me.Height / 2, 225)
    End Sub
    ...
    Protected Sub DrawGradient(ByVal PowderBlue As Color, ByVal SlateGray As Color, ByVal x As Integer, ByVal y As Integer, ByVal width As Integer, ByVal height As Integer, ByVal angle As Single)
        _Rectangle = New Rectangle(x, y, width, height)
        _Gradient = New LinearGradientBrush(_Rectangle, PowderBlue, Color.SlateGray, angle)
...
#Region " Convienence "
    ...
    Protected Sub DrawGradient(ByVal PowderBlue As Color, ByVal c2 As Color, ByVal x As Integer, ByVal y As Integer, ByVal width As Integer, ByVal height As Integer, ByVal angle As Single)
        _Rectangle = New Rectangle(x, y, width, height)
        _Gradient = New LinearGradientBrush(_Rectangle, PowderBlue, Color.DarkSlateGray, angle)
        G.FillRectangle(_Gradient, _Rectangle)
    End Sub
#End Region
...
Class SecureTheme
    ...
    Overrides Sub PaintHook()
        ...
        DrawGradient(Color.DimGray, Color.Black, 0, 0, Width, 20, 90S)
...
Class SecureButton
    ...
    Public Overrides Sub PaintHook()
        If MouseState = State.MouseDown Then
            DrawGradient(Color.PowderBlue, Color.DarkSlateGray, 0, 0, Width, Height, 90S)
        ElseIf MouseState = State.MouseOver Then
            DrawGradient(Color.PowderBlue, Color.DarkSlateGray, 0, 0, Width, Height, 90S)
        Else
            DrawGradient(Color.DimGray, Color.DarkGray, 0, 0, Width, Height, 90S)
        End If
...
Class SecureProgressBar
    ...
    Overrides Sub PaintHook()
        G.Clear(Color.Gray)
        If (_Value > 0) Then
            DrawGradient(Color.DarkSlateGray, Color.PowderBlue, 0, 0, CInt((_Value / _Maximum) * Width), Height, 90S)
        End If
        G.DrawRectangle(Pens.LightGray, 0, 0, Width - 1, Height - 1)
        DrawBorders(Pens.White, Pens.Transparent, ClientRectangle)
    End Sub
End Class