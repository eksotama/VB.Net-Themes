...
#Region " Convienence "
    ...
    Protected Sub DrawGradient(ByVal c1 As Color, ByVal c2 As Color, ByVal x As Integer, ByVal y As Integer, ByVal width As Integer, ByVal height As Integer, ByVal angle As Single)
        ...
        _Gradient = New LinearGradientBrush(_Rectangle, Color.DarkSlateGray, Color.Black, angle)
...
#Region " Convienence "
    ...
    Protected Sub DrawGradient(ByVal c4 As Color, ByVal c3 As Color, ByVal x As Integer, ByVal y As Integer, ByVal width As Integer, ByVal height As Integer, ByVal angle As Single)
        _Rectangle = New Rectangle(x, y, width, height)
        _Gradient = New LinearGradientBrush(_Rectangle, Color.DarkGray, Color.DarkSlateGray, angle)
        G.FillRectangle(_Gradient, _Rectangle)
    End Sub
#End Region
...
#Region " Convienence "
    ...
    Protected Sub DrawGradient(ByVal c1 As Color, ByVal c2 As Color, ByVal x As Integer, ByVal y As Integer, ByVal width As Integer, ByVal height As Integer, ByVal angle As Single)
        _Rectangle = New Rectangle(x, y, width, height)
        _Gradient = New LinearGradientBrush(_Rectangle, Color.SkyBlue, Color.LightGray, angle)
        G.FillRectangle(_Gradient, _Rectangle)
    End Sub
#End Region
...
Class STheme
    ...
    Overrides Sub PaintHook()
        G.Clear(BackColor)
        DrawGradient(Color.DarkSlateGray, Color.DarkGray, 0, 0, Width, 20, 90S)
        DrawGradient(Color.DimGray, Color.Black, 0, 20, Width, Height - 25, 90S)
        DrawGradient(Color.DarkGray, Color.Black, 0, Height - 25, Width, Height + 25 - Height, 90S)
        DrawGradient(Color.DarkGray, Color.DarkSlateGray, 0, Height + 25 - Height - 5, 10, Height - 45, 180S)
        DrawGradient(Color.DarkSlateGray, Color.Black, Width - 10, Height + 25 - Height - 5, 10, Height - 45, 180S)
...
Class SButton
    ...
    Public Overrides Sub PaintHook()
        If MouseState = State.MouseDown Then
            DrawGradient(Color.DarkSlateGray, Color.Black, 0, 0, Width, Height, 90S)
        ElseIf MouseState = State.MouseOver Then
            DrawGradient(Color.LightGray, Color.DarkSlateBlue, 0, 0, Width, Height, 90S)
        Else
            DrawGradient(Color.Black, Color.Black, 0, 0, Width, Height, 90S)
        End If
...
Class SProgressBar
    ...
    Overrides Sub PaintHook()
        ...
        If (_Value > 0) Then
            DrawGradient(Color.Black, Color.DarkSlateGray, 0, 0, CInt((_Value / _Maximum) * Width), Height, 90S)
        End If
