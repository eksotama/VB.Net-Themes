...
Class DoomThemeEdited
    ...
    Sub New()
        ...
        SetColor("Border", 33, 33, 33)
        SetColor("Back", 22, 22, 22)
    End Sub
    ...
    Protected Overrides Sub PaintHook()
        ...
        'Form Border
        Dim HB As New HatchBrush(HatchStyle.DarkDownwardDiagonal, Color.FromArgb(33, 33, 33), Color.FromArgb(10, 10, 10))
        ...
        'Title Box
        Dim HB3 As New HatchBrush(HatchStyle.DarkDownwardDiagonal, Color.FromArgb(33, 33, 33), Color.FromArgb(22, 22, 22))
    ...
    Protected Overrides Sub PaintHook()
        ...
        Select Case State
            Case MouseState.None
                Dim LGB As New LinearGradientBrush(New Rectangle(8, 20, Width - 10, Height - 8), Color.FromArgb(24, 24, 24), Color.FromArgb(15, 15, 15), 75.0F)
                G.FillRectangle(LGB, New Rectangle(1, 1, Width - 2, Height - 2))
                DrawText(TextColor, HorizontalAlignment.Center, 0, 0)
            Case MouseState.Over
                Dim LGB As New LinearGradientBrush(New Rectangle(8, 30, Width - 10, Height - 8), Color.FromArgb(24, 24, 24), Color.FromArgb(15, 15, 15), 75.0F)
                G.FillRectangle(LGB, New Rectangle(1, 1, Width - 2, Height - 2))
                DrawText(TextColor, HorizontalAlignment.Center, 0, 0)
            Case MouseState.Down
                Dim LGB As New LinearGradientBrush(New Rectangle(8, 70, Width - 10, Height - 8), Color.FromArgb(30, 192, 0, 0), Color.FromArgb(70, 192, 0, 0), 75.0F)
                G.FillRectangle(LGB, New Rectangle(1, 1, Width - 2, Height - 2))
                DrawText(TextColor, HorizontalAlignment.Center, 0, 0)
        End Select
...
Class DoomGroupBox
    ...
    Protected Overrides Sub PaintHook()
        G.Clear(Color.Black)
        'Group Area
        Dim BackBG As New HatchBrush(HatchStyle.DarkDownwardDiagonal, Color.FromArgb(20, 20, 20), Color.FromArgb(30, 30, 30))
        G.FillRectangle(BackBG, New Rectangle(0, 22, Width - 1, Height - 23))
        'Text Area
        Dim TopBG As New LinearGradientBrush(New Rectangle(0, 0, 75, 22), Color.FromArgb(20, 20, 20), Color.FromArgb(22, 22, 22), 180.0F)
...
#End Region
    ...
    Sub New()
        ...
        SetColor("Text", Color.Red)
        SetColor("Back", Color.FromArgb(255, 22, 22, 22))
        SetColor("Border1", Color.FromArgb(255, 50, 50, 50))
        SetColor("Border2", Color.FromArgb(255, 22, 22, 22))
        Font = New Font("Arial", 9)
    End Sub
...
#Region "Events"
    ...
    Protected Overrides Sub OnClick(ByVal e As System.EventArgs)
        ...
        For Each C As Control In Parent.Controls
            If C.GetType.ToString = Replace(My.Application.Info.ProductName, " ", "_") & ".DoomRadioButton" Then
                Dim CC As DoomRadioButton
                CC = C
                CC.Checked = False
            End If
        Next
