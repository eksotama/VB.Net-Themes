...
Class XtremeIncTheme
    ...
    Protected Overrides Sub PaintHook()
        ...
        Else
            G.DrawIcon(My.Resources.Icon, New Rectangle(10, 0, 32, 32))
        End If
...
Class XtremeIncProgressbar
    ...
    Protected Overrides Sub PaintHook()
        ...
        DrawGradient(Color.FromArgb(165, 0, 0), Color.FromArgb(255, 0, 0), 0, 0, CInt((_Value / _Maximum) * Width - 1), Height)
...
Class XtremeIncgroupbox
    ...
    Protected Overrides Sub PaintHook()
        ...
        DrawText(Brushes.Red, HorizontalAlignment.Left, 8, 1)
