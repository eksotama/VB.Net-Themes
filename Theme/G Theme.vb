...
'Version: 1.4
'This is the fixed version. -aeon


'Modified by +Crex on HackForums.net
'Original credits are above
'Enjoy :3!
...
Class GTheme
    ...
    Overrides Sub PaintHook()
        ...
        DrawText(HorizontalAlignment.Center, B1, 5 + ImageWidth)
...
Class GButton
    ...
    Sub New()
        ...
        C1 = Color.FromArgb(25, 25, 25)
        C2 = Color.FromArgb(43, 43, 43) 'above
        B1 = Color.FromArgb(204, 204, 204)
    End Sub
