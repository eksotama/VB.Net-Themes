...
Class SasisTheme
    ...
    Sub New()
        ...
        SetColor("Border", Color.FromArgb(168, 219, 4))
...
Class SasisProgressbar
    ...
    Protected Overrides Sub PaintHook()
        ...
        G.Clear(Color.FromArgb(0, 218, 240, 139))
        ...
        DrawBorders(New Pen(Color.FromArgb(218, 240, 139)), 1)
        DrawCorners(Color.Black)
        G.DrawLine(New Pen(Color.FromArgb(200, 218, 240, 139)), CInt(((Width / _Maximum) * _Value) - 2), 1, CInt(((Width / _Maximum) * _Value) - 2), Height - 2)
        ...
        G.FillRectangle(New SolidBrush(Color.FromArgb(168, 219, 4)), CInt(((Width / _Maximum) * _Value)) - 1, 2, Width - CInt(((Width / _Maximum) * _Value)) - 1, Height - 4)
        G.FillRectangle(HB, New Rectangle(0, 0, Width - 1, Height - 1))
        If Value > 0 Then G.FillRectangle(New SolidBrush(Color.FromArgb(168, 219, 4)), CInt(((Width / _Maximum) * _Value)) - 1, 2, Width - CInt(((Width / _Maximum) * _Value)) - 1, Height - 4)
    End Sub
...
Class SasisRadiobutton
    ...
    Private Sub InvalidateControls()
        ...
        For Each C As Control In Parent.Controls
            If C IsNot Me AndAlso TypeOf C Is SasisRadiobutton Then
                DirectCast(C, SasisRadiobutton).Checked = False
            End If
        Next
    End Sub
