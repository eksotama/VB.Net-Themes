'           Carbonite VB.Net Theme

' #############################################
' #          Creator: iZ3RO (ZerO)            #
' #            Date: 3 July, 2011             #
' #         Site: www.hackforums.net          #
' #               Version: 0.6                #
' #############################################
...
Class CarboniteTheme
    ...
    Public Overrides Sub PaintHook()
        ...
        'DrawGradient(Color.FromArgb(62, 62, 62), Color.FromArgb(38, 38, 38), 0, 0, Width, Height, 90S)   ' Form Gradient
        G.Clear(Color.FromArgb(62, 62, 62))
        DrawGradient(Color.FromArgb(62, 62, 62), Color.FromArgb(38, 38, 38), 0, 0, Width, 25, 90S)   ' Form Top Bar
