...
#Region " Recuperare Design Functions "
...
Public Module ColorConverter
    Public Function HexToRed(ByVal HexString As String) As Integer
        Return HexToColor(HexString).R
    End Function
    Public Function HexToGreen(ByVal HexString As String) As Integer
        Return HexToColor(HexString).G
    End Function
    Public Function HexToBlue(ByVal HexString As String) As Integer
        Return HexToColor(HexString).B
    End Function
    Public Function ColorToHex(ByVal Color As Color) As String
        Return String.Format("#{0}{1}{2}", Color.R.ToString("X2"), Color.G.ToString("X2"), Color.B.ToString("X2"))
    End Function
    Public Function HexToRGB(ByVal HexString As String) As String()
        Dim tmpColor As Color = ColorTranslator.FromHtml(HexString)
        Dim rgbArray(3) As String : rgbArray(0) = tmpColor.R.ToString()
        rgbArray(1) = tmpColor.G.ToString() : rgbArray(2) = tmpColor.B.ToString()
        Return rgbArray
    End Function
...
Class EmpressTheme
    ...
    Sub New()
        ...
        BackColor = ColorConverter.HexToColor("#DE873A")
        Font = New Font("Segoe UI", 9)
        SetColor("BackColor", ColorConverter.HexToColor("#A12F35"))
        SetColor("ForeColor", Color.White)
    End Sub
    ...
    Protected Overrides Sub PaintHook()
        ...
        G.FillPath(New SolidBrush(BackgroundColor), Draw.RoundRect(New Rectangle(0, 0, Width - 1, Height - 1), Curve))
        G.DrawPath(Pens.Black, Draw.RoundRect(New Rectangle(0, 0, Width - 1, Height - 1), Curve))
        G.SetClip(Draw.RoundRect(New Rectangle(0, 0, Width - 1, Height - 1), Curve))
        ...
        G.DrawString(FindForm().Text, Font, New SolidBrush(TextColor), New Point(35, 10))
    ...
    Protected Overrides Sub PaintHook()
        ...
        Select Case State
            Case MouseState.None
                Dim ButtonDefinition As New LinearGradientBrush(New Rectangle(0, 0, Width - 1, Height - 1), Color.FromArgb(5, Color.White), Color.FromArgb(55, Color.Black), 90S)
...
Public Class RecuperareControlBox : Inherits Control
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        G.Clear(BackColor)
        Dim ButtonFont As New Font("Marlett", 9.0F)
        ...
        Select Case ButtonState
            ...
            Case ButtonHover.Minimize
                G.DrawString("0", ButtonFont, New SolidBrush(Color.FromArgb(255, 255, 255)), New Point(20, 7), New StringFormat With {.Alignment = StringAlignment.Center})
            Case ButtonHover.Close
                G.DrawString("r", ButtonFont, New SolidBrush(Color.FromArgb(255, 255, 255)), New Point(Width - 16, 7), New StringFormat With {.Alignment = StringAlignment.Center})
        End Select
