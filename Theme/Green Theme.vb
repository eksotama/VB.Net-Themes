...
Class GreenTheme
    ...
    Dim C1, C2, C3, C4 As Color, P1, P2, P3 As Pen, B1 As SolidBrush, B2, B3 As LinearGradientBrush

    Sub New()

        SetStyle(ControlStyles.AllPaintingInWmPaint Or ControlStyles.UserPaint, True)
        C1 = Color.FromArgb(41, 57, 34) 'Background
        C2 = Color.FromArgb(190, 255, 159) 'Highlight
...
Class GreenButton
    ...
    Sub New()
        ...
        B5 = New SolidBrush(Color.FromArgb(201, 205, 37)) 'Text Color
...
#Region " Properties "
    ...
    Dim C2 As Color = Color.FromArgb(0, 128, 0) 'Dark Color
    Public Property Color1() As Color
        ...
        End Set
    End Property
    Dim C3 As Color = Color.FromArgb(0, 255, 0) 'Light color
...
#End Region
    ...
    Sub New()
        ...
        C1 = Color.FromArgb(0, 24, 0) 'Background
        P1 = New Pen(Color.FromArgb(70, Color.White), 2)
        P2 = New Pen(C2)
        P3 = New Pen(Color.FromArgb(65, 122, 49)) 'Highlight
...
Class GreenSeperator
    ...
    Sub New()
        ...
        C1 = Color.FromArgb(41, 57, 34) 'Background
        P1 = New Pen(Color.FromArgb(22, 22, 22)) 'Shadow
        P2 = New Pen(Color.FromArgb(0, 120, 0)) 'Highlight
    End Sub
