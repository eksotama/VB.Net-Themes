...
Class ComplexTheme
    ...
    Protected Overrides Sub PaintHook()
        G.Clear(Border)
        Dim HB As New HatchBrush(HatchStyle.DarkDownwardDiagonal, Color.FromArgb(2, Color.White), Color.Transparent)
        ...
        G.FillRectangle(HB, New Rectangle(0, 0, Width - 1, Height - 1))
        G.DrawString(Text, Font, TextBrush, New Point(30, 10))
...
Class ComplexRadioButton
    ...
    Private Sub InvalidateControls()
        ...
        For Each C As Control In Parent.Controls
            If C IsNot Me AndAlso TypeOf C Is ComplexRadioButton Then
                DirectCast(C, ComplexRadioButton).Checked = False
            End If
        Next
    End Sub
    ...
    Protected Overrides Sub PaintHook()
        ...
        If _Checked Then
            ...
            G.FillEllipse(New SolidBrush(Color.Gray), New Rectangle(4, 4, 8, 8))
        Else
            G.DrawEllipse(CircleColor, New Rectangle(0, 0, 16, 16))
        End If
    ...
    Public Sub New()
        SetColor("Text", Color.FromArgb(0, 0, 0))
        SetColor("Circle", Color.FromArgb(190, 190, 190))
